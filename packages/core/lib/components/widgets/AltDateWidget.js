...
function readyForChange(state) {
  ...
  return (0, _every["default"])(_context = (0, _keys["default"])(state)).call(_context, function (key) {
    return state[key] !== -1;
  });
}
...
function (_Component) {
  ...
  (0, _createClass2["default"])(AltDateWidget, [{
    ...
    value: function render() {
      ...
      }, (0, _map["default"])(_context2 = this.dateElementProps).call(_context2, function (elemProps, i) {
