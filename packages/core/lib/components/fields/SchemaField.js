...
function ErrorList(props) {
  ...
  }, (0, _map["default"])(_context = (0, _filter["default"])(errors).call(errors, function (elem) {
    return !!elem;
  })).call(_context, function (error, index) {
...
function SchemaFieldRender(props) {
  ...
  var classNames = (0, _trim["default"])(_context2 = ["form-group", "field", "field-".concat(type), errors && errors.length > 0 ? "field-error has-error has-danger" : "", uiSchema.classNames].join(" ")).call(_context2);
  var fieldProps = {
