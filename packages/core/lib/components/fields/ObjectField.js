...
function (_Component) {
  ...
  function ObjectField() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ObjectField)).call.apply(_getPrototypeOf2, _concatInstanceProperty(_context2 = [this]).call(_context2, args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "getAvailableKey", function (preferredKey, formData) {
      ...
      while (formData.hasOwnProperty(newKey)) {
        ...
        newKey = _concatInstanceProperty(_context3 = "".concat(preferredKey, "-")).call(_context3, ++index);
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "onKeyChange", function (oldValue) {
      return function (value, errorSchema) {
        ...
        var keyValues = _mapInstanceProperty(_context4 = _Object$keys(newFormData)).call(_context4, function (key) {
          var newKey = newKeys[key] || key;
          return _defineProperty({}, newKey, newFormData[key]);
        });

        var renamedObj = _extends.apply(void 0, _concatInstanceProperty(_context5 = [{}]).call(_context5, _toConsumableArray(keyValues)));
  ...
  _createClass(ObjectField, [{
    ...
    value: function isRequired(name) {
      ...
      return _Array$isArray(schema.required) && _indexOfInstanceProperty(_context6 = schema.required).call(_context6, name) !== -1;
    }
  }, {
    key: "getDefaultValue",
    ...
    value: function render() {
      ...
      var templateProps = {
        ...
        properties: _mapInstanceProperty(orderedProperties).call(orderedProperties, function (name) {
