...
var _objectSpread5 = _interopRequireDefault(require("@babel/runtime-corejs3/helpers/objectSpread"));
...
function DefaultObjectFieldTemplate(props) {
  ...
  return _react["default"].createElement("fieldset", {
    ...
    formContext: props.formContext
  }), (0, _map["default"])(_context = props.properties).call(_context, function (prop) {
    return prop.content;
...
function (_Component) {
  ...
  function ObjectField() {
    var _getPrototypeOf2, _context2;
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (_getPrototypeOf2 = (0, _getPrototypeOf3["default"])(ObjectField)).call.apply(_getPrototypeOf2, (0, _concat["default"])(_context2 = [this]).call(_context2, args)));
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getAvailableKey", function (preferredKey, formData) {
      ...
      while (formData.hasOwnProperty(newKey)) {
        ...
        newKey = (0, _concat["default"])(_context3 = "".concat(preferredKey, "-")).call(_context3, ++index);
      }
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onKeyChange", function (oldValue) {
      return function (value, errorSchema) {
        ...
        var keyValues = (0, _map["default"])(_context4 = (0, _keys["default"])(newFormData)).call(_context4, function (key) {
          var newKey = newKeys[key] || key;
          return (0, _defineProperty2["default"])({}, newKey, newFormData[key]);
        });

        var renamedObj = _assign["default"].apply(Object, (0, _concat["default"])(_context5 = [{}]).call(_context5, (0, _toConsumableArray2["default"])(keyValues)));
  ...
  (0, _createClass2["default"])(ObjectField, [{
    ...
    value: function isRequired(name) {
      ...
      return (0, _isArray["default"])(schema.required) && (0, _indexOf["default"])(_context6 = schema.required).call(_context6, name) !== -1;
    }
  }, {
    key: "getDefaultValue",
    ...
    value: function render() {
      ...
      var templateProps = {
        ...
        properties: (0, _map["default"])(orderedProperties).call(orderedProperties, function (name) {
