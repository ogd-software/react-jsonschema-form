...
var _includes = _interopRequireDefault(require("core-js/features/array/includes"));
...
function DefaultFixedArrayFieldTemplate(props) {
  ...
  }, props.items && (0, _map["default"])(_context = props.items).call(_context, DefaultArrayItem)), props.canAdd && _react["default"].createElement(_AddButton["default"], {
...
function DefaultNormalArrayFieldTemplate(props) {
  ...
  return _react["default"].createElement("fieldset", {
    ...
    className: "row array-item-list",
    key: "array-item-list-".concat(props.idSchema.$id)
  }, props.items && (0, _map["default"])(_context2 = props.items).call(_context2, function (p) {
...
function generateKeyedFormData(formData) {
  return !(0, _isArray["default"])(formData) ? [] : (0, _map["default"])(formData).call(formData, function (item) {
    return {
      key: generateRowId(),
      item: item
    };
...
function keyedToPlainFormData(keyedFormData) {
  return (0, _map["default"])(keyedFormData).call(keyedFormData, function (keyedItem) {
...
function (_Component) {
  ...
  function ArrayField(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onAddClick", function (event) {
      ...
      var newKeyedFormData = (0, _concat["default"])(_context3 = []).call(_context3, (0, _toConsumableArray2["default"])(_this.state.keyedFormData), [newKeyedFormDataRow]);
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onAddIndexClick", function (index) {
      return function (event) {
        ...
        (0, _splice["default"])(newKeyedFormData).call(newKeyedFormData, index, 0, newKeyedFormDataRow);
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onDropIndexClick", function (index) {
      return function (event) {
        ...
        var newKeyedFormData = (0, _filter["default"])(keyedFormData).call(keyedFormData, function (_, i) {
          return i !== index;
        });
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onReorderClick", function (index, newIndex) {
      return function (event) {
        ...
        function reOrderArray() {
          // Copy item
          var _newKeyedFormData = (0, _slice["default"])(keyedFormData).call(keyedFormData); // Moves item from index to newIndex


          (0, _splice["default"])(_newKeyedFormData).call(_newKeyedFormData, index, 1);
          (0, _splice["default"])(_newKeyedFormData).call(_newKeyedFormData, newIndex, 0, keyedFormData[index]);
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "onChangeForIndex", function (index) {
      return function (value, errorSchema) {
        ...
        var newFormData = (0, _map["default"])(formData).call(formData, function (item, i) {
  ...
  (0, _createClass2["default"])(ArrayField, [{
    ...
    value: function renderNormalArray() {
      ...
      var arrayProps = {
        ...
        items: (0, _map["default"])(_context4 = this.state.keyedFormData).call(_context4, function (keyedItem, index) {
    ...
    value: function renderFixedArray() {
      ...
      var ArrayFieldTemplate = registry.ArrayFieldTemplate,
          ...
          formContext = registry.formContext;
      var TitleField = fields.TitleField;
      var itemSchemas = (0, _map["default"])(_context5 = schema.items).call(_context5, function (item, index) {
      ...
      if (!items || items.length < itemSchemas.length) {
        ...
        items = items || [];
        items = (0, _concat["default"])(items).call(items, new Array(itemSchemas.length - items.length));
      ...
      var arrayProps = {
        ...
        idSchema: idSchema,
        formData: formData,
        items: (0, _map["default"])(_context6 = this.state.keyedFormData).call(_context6, function (keyedItem, index) {
          var key = keyedItem.key,
              item = keyedItem.item;
    ...
    value: function renderArrayFieldItem(props) {
      ...
      has.toolbar = (0, _some["default"])(_context7 = (0, _keys["default"])(has)).call(_context7, function (key) {
        return has[key];
      });
      return {
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      var newKeyedFormData = nextFormData.length === previousKeyedFormData.length ? (0, _map["default"])(previousKeyedFormData).call(previousKeyedFormData, function (previousKeyedFormDatum, index) {
        return {
