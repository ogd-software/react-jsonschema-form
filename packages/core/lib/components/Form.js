  ...
  function Form(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getFieldNames", function (pathSchema, formData) {
      var getAllPaths = function getAllPaths(_obj) {
        ...
        (0, _forEach["default"])(_context2 = (0, _keys["default"])(_obj)).call(_context2, function (key) {
          if ((0, _typeof2["default"])(_obj[key]) === "object") {
            var newPaths = (0, _map["default"])(paths).call(paths, function (path) {
              var _context3;

              return (0, _concat["default"])(_context3 = "".concat(path, ".")).call(_context3, key);
            });
