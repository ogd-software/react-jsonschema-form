...
function readyForChange(state) {
  ...
  return _everyInstanceProperty(_context = _Object$keys(state)).call(_context, function (key) {
    return state[key] !== -1;
  });
}
...
function (_Component) {
  ...
  _createClass(AltDateWidget, [{
    ...
    value: function render() {
      ...
      }, _mapInstanceProperty(_context2 = this.dateElementProps).call(_context2, function (elemProps, i) {
