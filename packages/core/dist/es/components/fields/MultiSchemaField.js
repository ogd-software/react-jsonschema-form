...
function (_Component) {
  ...
  function AnyOfField(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onOptionChange", function (option) {
      ...
      if (guessType(formData) === "object" && (newOption.type === "object" || newOption.properties)) {
        ...
        var optionsToDiscard = _sliceInstanceProperty(options).call(options);

        _spliceInstanceProperty(optionsToDiscard).call(optionsToDiscard, selectedOption, 1); // Discard any data added using other options
  ...
  _createClass(AnyOfField, [{
    ...
    value: function render() {
      ...
      var enumOptions = _mapInstanceProperty(options).call(options, function (option, index) {
        return {
      ...
      return React.createElement("div", {
        ...
        id: _concatInstanceProperty(_context = "".concat(idSchema.$id)).call(_context, schema.oneOf ? "__oneof_select" : "__anyof_select"),
        schema: {
          type: "number",
          "default": 0
        },
