  ...
  function Form(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getUsedFormData", function (formData, fields) {
      ...
      if (_Array$isArray(formData)) {
        ...
        return _mapInstanceProperty(_context = _Object$keys(data)).call(_context, function (key) {
          return data[key];
        });
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "getFieldNames", function (pathSchema, formData) {
      var getAllPaths = function getAllPaths(_obj) {
        ...
        _forEachInstanceProperty(_context2 = _Object$keys(_obj)).call(_context2, function (key) {
          if (_typeof(_obj[key]) === "object") {
            var newPaths = _mapInstanceProperty(paths).call(paths, function (path) {
              var _context3;
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (formData, newErrorSchema) {
      ...
      if (mustValidate) {
        ...
        if (_this.props.extraErrors) {
          errorSchema = mergeObjects(errorSchema, _this.props.extraErrors);
        ...
        var _errorSchema = _this.props.extraErrors ? mergeObjects(newErrorSchema, _this.props.extraErrors) : newErrorSchema;
    ...
    _defineProperty(_assertThisInitialized(_this), "onSubmit", function (event) {
      ...
      if (!_this.props.noValidate) {
        ...
        if (_Object$keys(_errors).length > 0) {
          if (_this.props.extraErrors) {
            _errorSchema2 = mergeObjects(_errorSchema2, _this.props.extraErrors);
